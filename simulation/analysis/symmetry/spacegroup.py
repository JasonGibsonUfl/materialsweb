# simulation/analysis/symmetry/spacegroup.py
...
class Translation(models.Model):
    ...
    Relationships:
        ...
        | :mod:`~simulation.Operation` via operation
...
class Operation(models.Model):
    ...
    Relationships:
        | :mod:`~simulation.Spacegroup` via spacegroup
        | :mod:`~simulation.Rotation` via rotation_set
        | :mod:`~simulation.Translation` via translation_set
...
class WyckoffSite(models.Model):
    ...
    Relationships:
        ...
        | :mod:`~simulation.Site` via site_set
...
class Spacegroup(models.Model):
    ...
    Relationships:
        ...
        | :mod:`~simulation.Translation` via centering_vectors
        | :mod:`~simulation.Operation` via operations
        | :mod:`~simulation.WyckoffSite` via site_set
    ...
    def get_site(self, symbol):
        ...
        print(type(self.site_set))
        symbol = symbol.strip('0123456789')
        print(self.site_set.get(symbol__exact=symbol,spacegroup=self))
