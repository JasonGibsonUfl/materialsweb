...
#from simulation.materials.structure import *
...
def _structure_to_cell(structure):
    ...
    """
    #if not isinstance(structure, structure.Structure):
     #   raise StructureError('Input is not of type `simulation.Structure`')
...
def _cell_to_structure(cell, structure, rev_lookup):
    ...
    """
    #if not isinstance(structure, simulation.Structure):
     #   raise simulation.StructureError('Input is not of type `simulation.Structure`')
