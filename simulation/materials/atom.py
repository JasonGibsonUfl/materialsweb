...
class Atom(models.Model):
    ...
    """
    structure = models.ForeignKey('simulation.Structure', related_name='atom_set', null=True, on_delete=models.CASCADE,)
    site = models.ForeignKey('Site', related_name='atom_set', null=True, on_delete=models.CASCADE,)

    # species
    element = models.ForeignKey('simulation.Element', blank=True, null=True, on_delete=models.CASCADE,)
    ...
    wyckoff = models.ForeignKey('WyckoffSite', blank=True, null=True, on_delete=models.CASCADE,)
    ...
    def __cmp__(self, other):
        comp_arr = [[self.x, other.x],
                    ...
                    [self.z, other.z],
                    [self.ox, other.ox],
                    [simulation.elements[self.element_id]['z'],
                     simulation.elements[other.element_id]['z']]]
...
class Site(models.Model):
    ...
    """
    structure = models.ForeignKey('simulation.Structure', related_name='site_set', blank=True, null=True, on_delete=models.CASCADE,)
    wyckoff = models.ForeignKey('WyckoffSite', blank=True, null=True, on_delete=models.CASCADE,)
    x = models.FloatField()
    y = models.FloatField()
    z = models.FloatField()
    ...
    def create(coord, comp=None):
        ...
        site.coord = coord
        if comp:
            if isinstance(comp, simulation.Element):
